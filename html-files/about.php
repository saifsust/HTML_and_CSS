	...
	<body>
		...
		<div class="mainContent template clear">
			...
			<div class="samepost clear">
				<h2>The Founder Of The Coaching Center</h2>
				<img src="../images/about/about.jpg" alt="post image"/>
				<p>
			...
			<div class="samepost clear">
				<h2>The Cofounder Of The Coaching Center</h2>
				<img src="../images/about/back.jpeg" alt="post image"/>
				<p>
					The number √n r0 is the length of each of the radius vectors representing the
					n roots.
					The first root c0 has argument θ0/n; and the two roots when n = 2 lie at
