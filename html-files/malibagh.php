...
<html>
	...
	<body>
						...
						<ul id="main-menu">
							...
							<li class="parent">
								...
								<ul class="sub-menu">
									...
									<li><a href="badda.php">malibagh</a></li>
								</ul>
							</li>
							<li class="parent">
		...
		<div class="sliderSection template clear">
			<div id="slider">
				<a href="#"><img src="../images/malibagh/01.jpg" alt="nature 1" title=" SAIFUl ISLAM" /></a>
				<a href="#"><img src="../images/malibagh/02.jpg" alt="nature 2" title="Liton" /></a>
				<a href="#"><img src="../images/malibagh/03.jpg" alt="nature 3"  title="BABU" /></a>
				<a href="#"><img src="../images/malibagh/04.jpg" alt="nature 4"  title="kobri" /></a>
			</div>
		</div>
